...
const ResetPassword = () => {
    ...
    const resetPassword = async (data) => {
        setLoading(true);
        try {
            const response = await fetch(`https://skynetsilicon-website-backend.vercel.app/api/auth/reset-password/${token}`, {
                method: "POST",
        ...
        <>
            <div className="w-screen flex items-center justify-center h-screen bg-[#010205ee]">
                <div className="lg:w-[50%] xl:w-[40%] 2xl:w-[33%] p-3 relative rounded-none z-[999] shadow-2xl" style={{ background: `url(${loginBg})` }}>
                    ...
                    {/* Form */}
                    <form className="p-3 z-[99999] mt-4" onSubmit={handleSubmit(resetPassword)}>
                        <div className="mb-4">
